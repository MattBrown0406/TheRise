...
Both products must be **Ready to Submit** before the new version is submitted. Add the subscription group and both subscriptions as review items with version 1.0 build 13; do not submit only the binary.
...
8. Build and upload version 1.0 build 13.
9. Open **Monetization > Subscriptions > Rise Subscriptions**. Select both products and click **Add for Review**.
10. Add the products to the same draft submission as iOS version 1.0 build 13. Because this is the first subscription group, confirm the group is included too.
...
Send only after build 13, the subscription group, and both subscriptions have been submitted for review:

```text
Hello,

Thank you for the review. We addressed the outstanding issue in version 1.0 build 13.
...
Guideline 2.1(b): The App Review submission now includes iOS version 1.0 build 13, the Rise Subscriptions subscription group, The Rise Pro Monthly (`therise_pro_monthly`), and The Rise Pro Annual (`therise_pro_annual`). Both products include localization, pricing, availability, App Review screenshots, and review notes.
